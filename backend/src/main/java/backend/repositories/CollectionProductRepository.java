...
@Repository
public interface CollectionProductRepository extends JpaRepository<CollectionProduct, java.util.UUID> {

    Optional<CollectionProduct> findByCollectionIdAndProductId(java.util.UUID collectionId, java.util.UUID productId);

    boolean existsByCollectionIdAndProductId(java.util.UUID collectionId, java.util.UUID productId);

    long countByCollectionId(java.util.UUID collectionId);

    List<CollectionProduct> findAllByCollectionId(java.util.UUID collectionId);

    List<CollectionProduct> findAllByCollectionIdAndSource(java.util.UUID collectionId, CollectionMembershipSource source);
    ...
    List<Object[]> findProductCollectionPairs(@Param("productIds") Collection<java.util.UUID> productIds);
    ...
    int deleteByCollectionIdAndSource(@Param("collectionId") java.util.UUID collectionId,
    ...
    int deleteAllByProductId(@Param("productId") java.util.UUID productId);
}
